...
//for lipo 5400 - work but to fast
// float pid_p_gain_roll = 1.3;   //Gain setting for the roll P-controller
// float pid_i_gain_roll = 0.03;  //Gain setting for the roll I-controller
// float pid_d_gain_roll = 18.0;  //Gain setting for the roll D-controller
// int pid_max_roll = 400;        //Maximum output of the PID-controller (+/-)

float pid_p_gain_roll = 1.25;   //Gain setting for the roll P-controller
...
// float pid_d_gain_roll = 0.0;  //Gaixn setting for the roll D-controller
// int pid_max_roll = 400;       //Maximum output of the PID-controller (+/-)
...
//for test
float pid_i_mem_roll_original, pid_roll_setpoint_original, pid_error_temp_original, pid_output_roll_original;
...
void loop() {
  ...
  angle_roll_acc -= 3.2;  //Accelerometer calibration value for roll.
...
//quire good
  ...
  pitch_level_adjust = angle_pitch*2;  //Calculate the pitch angle correction
  roll_level_adjust = angle_roll*2;    //Calculate the roll angle correction
  ...
  //for test
  pid_roll_setpoint_original = pid_roll_setpoint;

  pid_roll_setpoint -= roll_level_adjust;  //Subtract the angle correction from the standardized receiver roll input value.
  pid_roll_setpoint /= 3.0;                //Divide the setpoint for the PID roll controller by 3 to get angles in degrees.
  //for test
  pid_roll_setpoint_original /= 3.0;

  // Serial.print("  rollAjusted:");
  // Serial.print(pid_roll_setpoint);
...
void calculate_pid() {
  ...
  //for test
  pid_error_temp_original = gyro_roll_input - pid_roll_setpoint_original;

  pid_i_mem_roll += pid_i_gain_roll * pid_error_temp;

  //for test
  pid_i_mem_roll_original += pid_i_gain_roll * pid_error_temp_original;
  ...
  //for test
  pid_output_roll_original = pid_p_gain_roll * pid_error_temp_original + pid_i_mem_roll + pid_d_gain_roll * (pid_error_temp_original - pid_last_roll_d_error);
  ...
  if (logEnabled) {
    ...
    Serial.print(" pid_output_roll_original ");
    Serial.println(pid_output_roll_original);
  }

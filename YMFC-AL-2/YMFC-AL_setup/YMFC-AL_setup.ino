...
void loop(){
  ...
  if(error == 0){  
    ...
    //Check for thrphảiottle movement
    ...
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("Move the roll stick to simulate left wing up and back to center - stick phải - qua phải"));
  ...
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
    Serial.println(F("Move the yaw stick to simulate nose right and back to center - stick trái - qua phải"));
    //Check for throttle movement

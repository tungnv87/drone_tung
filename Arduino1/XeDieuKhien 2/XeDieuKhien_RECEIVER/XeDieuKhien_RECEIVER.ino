...
#define in3 5
#define in4 6
RF24 radio(8, 10); // CE, CSN <-- updated 9 -> 10
...
void loop() {
  if (radio.available()) {   // If the NRF240L01 module received data
    Serial.println("nv__radio available:  ");
  ...
  //  Serial.println("nv__yAxis:", String(yAxis));
  //  Serial.println("nv__xAxis:", String(xAxis));
//  Serial.println("nv___test x: ");
//  Serial.print(xAxis);
//  Serial.print(", y: ");

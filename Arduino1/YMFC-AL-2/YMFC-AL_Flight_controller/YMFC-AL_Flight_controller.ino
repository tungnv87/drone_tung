...
void loop() {
  ...
  pid_output_yaw = -pid_output_yaw;     //just for test
  ...
  // Serial.print(" ESC4 "); Serial.print(esc_4);
  // Serial.print(" yawinput "); Serial.print(gyro_yaw_input);
  // Serial.print(" lastYaw "); Serial.print(pid_last_yaw_d_error);
  // Serial.println();
  // Serial.print(", battery: "); Serial.print(battery_voltage);
  // Serial.print("ESC1**: "); Serial.print(pid_output_pitch + pid_output_roll - pid_output_yaw);
